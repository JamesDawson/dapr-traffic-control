...
#
$SolutionToBuild = (Resolve-Path (Join-Path $here "src/dapr-traffic-control.sln")).Path
$ProjectsToPublish = @(
    "src/TrafficControlService/TrafficControlService.csproj"
    "src/VehicleRegistrationService/VehicleRegistrationService.csproj"
    "src/FineCollectionService/FineCollectionService.csproj"
)
